<?php
    ...
    $app->get("/projetos/editar/{id}",'App\Action\ProjetosModelAction:editar')->add(App\Middleware\AuthMiddleware::class .':buildProjeto')->add(App\Middleware\AuthMiddleware::class);
